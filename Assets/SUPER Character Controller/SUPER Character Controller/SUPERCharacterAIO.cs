...
public class SUPERCharacterAIO : MonoBehaviour{
    ...
    public static float Sensitivity = 30;
...
public class SuperFPEditor : Editor{
    ...
    public override void OnInspectorGUI(){
        ...
        if(cameraSettingsFoldout){
            ...
            SUPERCharacterAIO.Sensitivity = EditorGUILayout.Slider(new GUIContent("Mouse Sensitivity", "Sensitivity of the mouse"), SUPERCharacterAIO.Sensitivity, 1,50);
